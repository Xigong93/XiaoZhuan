 ...
 * 参数输入框
 */
class ParamInput(private val param: ApkChannelTask.Param, value: String?, private val onValueChange: (String) -> Unit) {
...
fun ParamInputPreview() {
    ParamInput(param = ApkChannelTask.Param("ApiKey", null, "ApiKey"), null) {}.render()
}